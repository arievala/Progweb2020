...
pantalla=document.getElementById("textoPantalla"); //elemento pantalla de salida
   ...
   document.querySelector("#octal").addEventListener("click",function(){
     var n = parseInt(x);
         pantalla.innerHTML = n.toString(8); //mostrar en pantalla resultado
         op="no"; //quitar operaciones pendientes.
         xi=1;
},false);

  document.querySelector("#hexadecimal").addEventListener("click",function(){
     var n = parseInt(x);
         pantalla.innerHTML = n.toString(16); //mostrar en pantalla resultado
         op="no"; //quitar operaciones pendientes.
         xi=1;
},false);

    document.querySelector("#binario").addEventListener("click",function(){
     var n = parseInt(x);
         pantalla.innerHTML = n.toString(2); //mostrar en pantalla resultado
         op="no"; //quitar operaciones pendientes.
         xi=1;
},false);
...
function logaritmo(){
  s = parseInt(x);
  pantalla.innerHTML = Math.log10(s);
  op="no"; //quitar operaciones pendientes.
         xi=1;
} 
...
function logaritmo_natural(){
  s = parseInt(x);
  pantalla.innerHTML = Math.log2(s);
  op="no"; //quitar operaciones pendientes.
         xi=1;
} 