...
function escribeMensaje(){
  document.write(palindromo("<h2 style='color:red'>La ruta nos aporto otro paso natural</h2><br>"));
  document.write(palindromo("<h2 style='color:blue'>Esta frase no se parece a ningun palindromo</h2>"));
}
